    ...
    public class CartController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View(new CartModel(){
                ...
                CartItems = cart.CartItems.Select(i=>new CartItemModel()
                {
                    ...
                    Name = i.Product.Name,
                    Price = (double)i.Product.Price, //nullable old için 
        ...
        public IActionResult Checkout(OrderModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                //cart bilgisi form dışında olduğu için
                //tekrar hiddenlarla uğraşmak yerine
                //burada db den çekip, model içine atıyoruz
        ...
        public IActionResult GetOrders()
        {
            ...
            foreach(var order in orders)
            {
                ...
                orderModel.OrderItems = order.OrderItems.Select(i=>new OrderItemModel(){
                    OrderItemId = i.Id,
                    Name = i.Product.Name,
                    //cart için güncel fiyat gerekli olduğu için i.Product.Price
                    //ama order için order anındaki fiyat gerekli olduğu için i.Price
